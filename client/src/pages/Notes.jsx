        ...
        <div className='min-h-screen bg-gradient-to-br from-gray-100 to-gray-200 px-6 py-8'>
            <motion.header
                ...
                <div className='flex items-center gap-2 flex-wrap'>
                    ...
                    <button onClick={() => { navigate("/history") }} className='px-4 py-3 rounded-full text-sm font-medium bg-white/10 border border-white/20 text-white hover:bg-white/20 transition flex items-center gap-2 cursor-pointer'>
                        📚 Your Notes
                    </button>
                </div>
            </motion.header>
            ...
            {!result && <motion.div
                ...
                className='h-64 rounded-2xl flex flex-col items-center justify-center bg-white/60 backdrop-blur-lg border border-dashed border-gray-300 text-gray-500 shadow-linear'
            >
