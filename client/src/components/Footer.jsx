            ...
            <div className='grid grid-cols-1 md:grid-cols-3 gap-8 items-start'>
                <motion.div
                    ...
                    <div className='flex items-center gap-3 cursor-pointer'
                        ...
                        <img src={img} alt="Logo" className="w-9 h-9 object-contain" />
                ...
                <div className='text-center'>
                    ...
                    <ul className='space-y-2 text-sm'>
                        <li className='text-gray-300 hover:text-white transition-colors cursor-pointer' onClick={() => navigate("/auth")}>
                            SignIn
                        </li>
                        <li className='text-red-400 hover:text-red-300 transition-colors cursor-pointer' onClick={handleSignOut}>SignOut</li>
                        <li className='text-gray-300 hover:text-white transition-colors cursor-pointer'>puneetprajapati9936@gmail.com</li>
                    </ul>
                </div>
            </div>
            <div className='my-6 h-px bg-white/10'/>
            <p className='text-center text-xs text-gray-500'>&copy; {new Date().getFullYear()} ExamNotes AI. All rights reserved.</p>
        </motion.div>
    )
}
