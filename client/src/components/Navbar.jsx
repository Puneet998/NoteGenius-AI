            ...
            <div className='flex items-center gap-6 relative'>
                <div className='relative'>
                    ...
                    className="absolute right-[-50px] mt-4 w-64 rounded-2xl bg-black/90 backdrop-blur-xl border border-white/10 shadow-[0_25px_60px_rgba(0,0,0,0.7)] p-4 text-white">
                        <h4 className="font-semibold mb-2">Buy Creditss</h4>
                        ...
                        className="w-full py-2 rounded-lg bg-gradient-to-br from-white to-gray-299 text-black font-semibold hover:opacity-90 cursor-pointer">Buy More Credits</button>
                    </motion.div>
                    }</AnimatePresence>
                </div>
               ...
               <div className='relative'>
                    <motion.div
                        ...
                        whileTap={{ scale: 0.97 }}
                        className='flex items-center gap-2 px-4 py-2 rounded-full bg-white/10 border border-white/20 text-white text-sm shadow-md cursor-pointer'  >
                        <span className='text-md'><abbr style={{"textDecoration":"none"}} title={userData.name}>{userData?.name.slice(0,1).toUpperCase()}</abbr></span>                        
                    </motion.div>
                    ...
                    className="absolute right-0 mt-4 w-52 rounded-2xl bg-black/90 backdrop-blur-xl border border-white/10 shadow-[0_25px_60px_rgba(0,0,0,0.7)] p-4 text-white">
                     ...
                     <MenuItem text="sign out" onClick={()=>{handleSignOut(); setShowProfile(false)}} red/>
