            ...
            {quickRevision && <section className='rounded-xl bg-gradient-to-r from-green-100 to-green-50 border border-green-200 p-6'>
                ...
                {result.diagram?.data && <section>
                    ...
                    <p className='mt-3 text-xs text-gray-500'>
                        ⬇️<span className="italic">If you need this diagram for future reference or revision, you can save it by taking a screenshot</span>
                    </p>
                </section>}
                ...
                <p className='mt-3 text-xs text-gray-500'>
                        ⬇️<span className="italic">If you need this chart for future reference or revision, you can save it by taking a screenshot</span>
                    </p>
                </section>}
