...
const TopicForm = ({ setResult, setLoading, loading, setError,error }) => {
    ...
    return (
        ...
        >
            ...
            <input type="text" className='w-full p-3 rounded-xl bg-white/10 backdrop-blur-lg border border-white/20 placeholder-gray-400 text-white focus:outline-none focus:ring-2 focus:ring-white/30'
                ...
                value={classLevel} onChange={(e) => {
                    setClassLevel(e.target.value)
                }} />

            <input type="text" className='w-full p-3 rounded-xl bg-white/10 backdrop-blur-lg border border-white/20 placeholder-gray-400 text-white focus:outline-none focus:ring-2 focus:ring-white/30'
                placeholder='Exam Type (e.g. CBSE, JEE, NEET)'
                value={examType} onChange={(e) => {
            ...
            className={`
                ...
                ${
                    ...
                    : "bg-gradient-to-br from-white to-gray-200 text-black shadow-[0_15px_35px_rgba(0,0,0,0.4)] hover:opacity-90 cursor-pointer"
                }
                `}>
        ...
        <div className='flex items-center gap-4 cursor-pointer select-none' onClick={onChange}>
            ...
            >
                <motion.div
                    ...
                    className='absolute top-0.5 h-5 w-5  bg-white rounded-full shadow-[0_5px_15px_rgba(0,0,0,0.5)]'
